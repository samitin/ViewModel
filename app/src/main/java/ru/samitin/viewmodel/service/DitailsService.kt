package ru.samitin.viewmodel.service
...
import ru.samitin.viewmodel.view.*
...
private const val REQUEST_TIME_OUT=10_000
private const val REQUEST_API_KEY="X-Yandex-API_Key"

class DitailsService(name:String="DitailsService"): IntentService(name) {
    ...
    private fun putLoadResult(result:String) {
        broadcastIntent.putExtra(DETALS_LOAD_RESULT_EXTRA,result)
    }
