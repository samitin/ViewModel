...
import ru.samitin.viewmodel.service.DitailsService
import ru.samitin.viewmodel.service.LATITUDE_EXTRA
import ru.samitin.viewmodel.service.LONGITUDE_EXTRA
...
class DetailsFragment : Fragment() {
    ...
    private fun getWeather() {
        ...
        context?.let {
            it.startService(Intent(it, DitailsService::class.java).apply {
                putExtra(
                    LATITUDE_EXTRA,
